...
sudo pm -Su --noconfirm --needed curl git zsh zip unzip otf-font-awesome base-devel blueman wl-clipboard cliphist hyprpaper hyprlock bat networkmanager network-manager-applet ghostty hyprland jq fzf ttf-jetbrains-mono-nerd hyprshot
